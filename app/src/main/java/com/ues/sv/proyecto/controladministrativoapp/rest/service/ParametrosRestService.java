...
public class ParametrosRestService extends AbsRestServiceImpl<Parametros, ParametrosRestServiceInterface, Long> {

    public ParametrosRestService() {
        super(new AbsRestService<Parametros, Long, ParametrosRestServiceInterface>() {
            @Override
            public void registrarEntidad(Parametros parametros, CallBackDisposableInterface<Parametros> disposableInterface, ParametrosRestServiceInterface restServiceInterface) {
            ...
            @Override
            public void editarEntidad(Parametros parametros, CallBackDisposableInterface<Parametros> disposableInterface, ParametrosRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override

                    public Single<?> singleAction() {
                        return restServiceInterface.update(parametros);
                    }
            ...
            @Override
            public void eliminarEntidad(Parametros parametros, CallBackVoidInterface voidInterface, ParametrosRestServiceInterface restServiceInterface) {
            ...
            @Override
            public void buscarPorId(Long id, CallBackDisposableInterface<Parametros> disposableInterface, ParametrosRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override
            ...
            @Override
            public void obtenerListaEntidad(CallBackDisposableInterface<List<Parametros>> disposableInterface, ParametrosRestServiceInterface restServiceInterface) {
