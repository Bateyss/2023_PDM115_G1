...
public class EvaluacionRestService extends AbsRestServiceImpl<Evaluacion, EvaluacionRestServiceInterface, Long> {

    public EvaluacionRestService() {
        super(new AbsRestService<Evaluacion, Long, EvaluacionRestServiceInterface>() {
            @Override
            public void registrarEntidad(Evaluacion evaluacion, CallBackDisposableInterface<Evaluacion> disposableInterface, EvaluacionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    ...
                    public Disposable completableCallBack(Single<?> applySubscribe) {
                        return applySubscribe.subscribe(object -> disposableInterface.onCallBack((Evaluacion) object)
                                , throwable -> {
            ...
            @Override
            public void editarEntidad(Evaluacion evaluacion, CallBackDisposableInterface<Evaluacion> disposableInterface, EvaluacionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override

                    public Single<?> singleAction() {
                        return restServiceInterface.update(evaluacion);
                    }
            ...
            @Override
            public void eliminarEntidad(Evaluacion evaluacion, CallBackVoidInterface voidInterface, EvaluacionRestServiceInterface restServiceInterface) {
            ...
            @Override
            public void buscarPorId(Long id, CallBackDisposableInterface<Evaluacion> disposableInterface, EvaluacionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override
            ...
            @Override
            public void obtenerListaEntidad(CallBackDisposableInterface<List<Evaluacion>> disposableInterface, EvaluacionRestServiceInterface restServiceInterface) {
    ...
    @Override
    protected EvaluacionRestServiceInterface getRest() {
        return OkHttpClientInstance.evaluacionRestServiceInterface();
    }
}
