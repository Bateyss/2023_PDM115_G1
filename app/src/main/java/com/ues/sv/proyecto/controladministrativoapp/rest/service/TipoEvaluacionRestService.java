...
public class TipoEvaluacionRestService extends AbsRestServiceImpl<TipoEvaluacion, TipoEvaluacionRestServiceInterface, Long> {

    public TipoEvaluacionRestService() {
        super(new AbsRestService<TipoEvaluacion, Long, TipoEvaluacionRestServiceInterface>() {
            @Override
            public void registrarEntidad(TipoEvaluacion tipoEvaluacion, CallBackDisposableInterface<TipoEvaluacion> disposableInterface, TipoEvaluacionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    ...
                    public Disposable completableCallBack(Single<?> applySubscribe) {
                        return applySubscribe.subscribe(object -> disposableInterface.onCallBack((TipoEvaluacion) object)
                                , throwable -> {
            ...
            @Override
            public void editarEntidad(TipoEvaluacion tipoEvaluacion, CallBackDisposableInterface<TipoEvaluacion> disposableInterface, TipoEvaluacionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override

                    public Single<?> singleAction() {
                        return restServiceInterface.update(tipoEvaluacion);
                    }
            ...
            @Override
            public void eliminarEntidad(TipoEvaluacion tipoEvaluacion, CallBackVoidInterface voidInterface, TipoEvaluacionRestServiceInterface restServiceInterface) {
            ...
            @Override
            public void buscarPorId(Long id, CallBackDisposableInterface<TipoEvaluacion> disposableInterface, TipoEvaluacionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override
            ...
            @Override
            public void obtenerListaEntidad(CallBackDisposableInterface<List<TipoEvaluacion>> disposableInterface, TipoEvaluacionRestServiceInterface restServiceInterface) {
    ...
    @Override
    protected TipoEvaluacionRestServiceInterface getRest() {
        return OkHttpClientInstance.tipoEvaluacionRestServiceInterface();
    }
}
