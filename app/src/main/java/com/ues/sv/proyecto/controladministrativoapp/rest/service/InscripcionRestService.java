...
public class InscripcionRestService extends AbsRestServiceImpl<Inscripcion, InscripcionRestServiceInterface, Long> {

    public InscripcionRestService() {
        super(new AbsRestService<Inscripcion, Long, InscripcionRestServiceInterface>() {
            @Override
            public void registrarEntidad(Inscripcion inscripcion, CallBackDisposableInterface<Inscripcion> disposableInterface, InscripcionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    ...
                    public Disposable completableCallBack(Single<?> applySubscribe) {
                        return applySubscribe.subscribe(object -> disposableInterface.onCallBack((Inscripcion) object)
                                , throwable -> {
            ...
            @Override
            public void editarEntidad(Inscripcion inscripcion, CallBackDisposableInterface<Inscripcion> disposableInterface, InscripcionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override

                    public Single<?> singleAction() {
                        return restServiceInterface.update(inscripcion);
                    }
            ...
            @Override
            public void eliminarEntidad(Inscripcion inscripcion, CallBackVoidInterface voidInterface, InscripcionRestServiceInterface restServiceInterface) {
            ...
            @Override
            public void buscarPorId(Long id, CallBackDisposableInterface<Inscripcion> disposableInterface, InscripcionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override
            ...
            @Override
            public void obtenerListaEntidad(CallBackDisposableInterface<List<Inscripcion>> disposableInterface, InscripcionRestServiceInterface restServiceInterface) {
    ...
    @Override
    protected InscripcionRestServiceInterface getRest() {
        return OkHttpClientInstance.inscripcionRestServiceInterface();
    }
}
