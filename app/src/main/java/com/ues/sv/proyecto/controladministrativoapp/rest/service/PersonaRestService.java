...
public class PersonaRestService extends AbsRestServiceImpl<Persona, PersonaRestServiceInterface, Long> {

    public PersonaRestService() {
        super(new AbsRestService<Persona, Long, PersonaRestServiceInterface>() {
            @Override
            public void registrarEntidad(Persona persona, CallBackDisposableInterface<Persona> disposableInterface, PersonaRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    ...
                    public Disposable completableCallBack(Single<?> applySubscribe) {
                        return applySubscribe.subscribe(object -> disposableInterface.onCallBack((Persona) object)
                                , throwable -> {
            ...
            @Override
            public void editarEntidad(Persona persona, CallBackDisposableInterface<Persona> disposableInterface, PersonaRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override

                    public Single<?> singleAction() {
                        return restServiceInterface.update(persona);
                    }
            ...
            @Override
            public void eliminarEntidad(Persona persona, CallBackVoidInterface voidInterface, PersonaRestServiceInterface restServiceInterface) {
            ...
            @Override
            public void buscarPorId(Long id, CallBackDisposableInterface<Persona> disposableInterface, PersonaRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override
            ...
            @Override
            public void obtenerListaEntidad(CallBackDisposableInterface<List<Persona>> disposableInterface, PersonaRestServiceInterface restServiceInterface) {
    ...
    @Override
    protected PersonaRestServiceInterface getRest() {
        return OkHttpClientInstance.personaRestServiceInterface();
    }
}
