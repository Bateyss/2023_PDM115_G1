...
public class EncargadoImpresionRestService extends AbsRestServiceImpl<EncargadoImpresion, EncargadoImpresionRestServiceInterface, Long> {

    public EncargadoImpresionRestService() {
        super(new AbsRestService<EncargadoImpresion, Long, EncargadoImpresionRestServiceInterface>() {
            @Override
            public void registrarEntidad(EncargadoImpresion encargadoImpresion, CallBackDisposableInterface<EncargadoImpresion> disposableInterface, EncargadoImpresionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    ...
                    public Disposable completableCallBack(Single<?> applySubscribe) {
                        return applySubscribe.subscribe(object -> disposableInterface.onCallBack((EncargadoImpresion) object)
                                , throwable -> {
            ...
            @Override
            public void editarEntidad(EncargadoImpresion encargadoImpresion, CallBackDisposableInterface<EncargadoImpresion> disposableInterface, EncargadoImpresionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override

                    public Single<?> singleAction() {
                        return restServiceInterface.update(encargadoImpresion);
                    }
            ...
            @Override
            public void eliminarEntidad(EncargadoImpresion encargadoImpresion, CallBackVoidInterface voidInterface, EncargadoImpresionRestServiceInterface restServiceInterface) {
            ...
            @Override
            public void buscarPorId(Long id, CallBackDisposableInterface<EncargadoImpresion> disposableInterface, EncargadoImpresionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override
            ...
            @Override
            public void obtenerListaEntidad(CallBackDisposableInterface<List<EncargadoImpresion>> disposableInterface, EncargadoImpresionRestServiceInterface restServiceInterface) {
    ...
    @Override
    protected EncargadoImpresionRestServiceInterface getRest() {
        return OkHttpClientInstance.encargadoImpresionRestServiceInterface();
    }
}
