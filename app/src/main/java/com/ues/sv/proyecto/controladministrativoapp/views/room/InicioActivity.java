...
import com.ues.sv.proyecto.controladministrativoapp.room.service.PruebaService;
...
public class InicioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pruebaService = new PruebaService(getApplicationContext());
    ...
    private void cargarDatosDePrueba() {
        pruebaService.cargarDatosDePrueba();
    }
