...
public class MateriaRestService extends AbsRestServiceImpl<Materia, MateriaRestServiceInterface, Long> {

    public MateriaRestService() {
        super(new AbsRestService<Materia, Long, MateriaRestServiceInterface>() {
            @Override
            public void registrarEntidad(Materia materia, CallBackDisposableInterface<Materia> disposableInterface, MateriaRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    ...
                    public Disposable completableCallBack(Single<?> applySubscribe) {
                        return applySubscribe.subscribe(object -> disposableInterface.onCallBack((Materia) object)
                                , throwable -> {
            ...
            @Override
            public void editarEntidad(Materia materia, CallBackDisposableInterface<Materia> disposableInterface, MateriaRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override

                    public Single<?> singleAction() {
                        return restServiceInterface.update(materia);
                    }
            ...
            @Override
            public void eliminarEntidad(Materia materia, CallBackVoidInterface voidInterface, MateriaRestServiceInterface restServiceInterface) {
            ...
            @Override
            public void buscarPorId(Long id, CallBackDisposableInterface<Materia> disposableInterface, MateriaRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override
            ...
            @Override
            public void obtenerListaEntidad(CallBackDisposableInterface<List<Materia>> disposableInterface, MateriaRestServiceInterface restServiceInterface) {
    ...
    @Override
    protected MateriaRestServiceInterface getRest() {
        return OkHttpClientInstance.materiaRestServiceInterface();
    }
}
