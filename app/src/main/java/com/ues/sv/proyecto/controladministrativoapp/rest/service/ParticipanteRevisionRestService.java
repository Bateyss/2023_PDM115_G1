...
public class ParticipanteRevisionRestService extends AbsRestServiceImpl<ParticipanteRevision, ParticipanteRevisionRestServiceInterface, Long> {

    public ParticipanteRevisionRestService() {
        super(new AbsRestService<ParticipanteRevision, Long, ParticipanteRevisionRestServiceInterface>() {
            @Override
            public void registrarEntidad(ParticipanteRevision participanteRevision, CallBackDisposableInterface<ParticipanteRevision> disposableInterface, ParticipanteRevisionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    ...
                    public Disposable completableCallBack(Single<?> applySubscribe) {
                        return applySubscribe.subscribe(object -> disposableInterface.onCallBack((ParticipanteRevision) object)
                                , throwable -> {
            ...
            @Override
            public void editarEntidad(ParticipanteRevision participanteRevision, CallBackDisposableInterface<ParticipanteRevision> disposableInterface, ParticipanteRevisionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override

                    public Single<?> singleAction() {
                        return restServiceInterface.update(participanteRevision);
                    }
            ...
            @Override
            public void eliminarEntidad(ParticipanteRevision participanteRevision, CallBackVoidInterface voidInterface, ParticipanteRevisionRestServiceInterface restServiceInterface) {
            ...
            @Override
            public void buscarPorId(Long id, CallBackDisposableInterface<ParticipanteRevision> disposableInterface, ParticipanteRevisionRestServiceInterface restServiceInterface) {
                DisposableUtils.addComposite(new DisposableUtils.CompositeSingleCallbac() {
                    @Override
            ...
            @Override
            public void obtenerListaEntidad(CallBackDisposableInterface<List<ParticipanteRevision>> disposableInterface, ParticipanteRevisionRestServiceInterface restServiceInterface) {
    ...
    @Override
    protected ParticipanteRevisionRestServiceInterface getRest() {
        return OkHttpClientInstance.participanteRevisionRestServiceInterface();
    }
}
